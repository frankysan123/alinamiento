...
def exportar_excel(df_division, resultados):
    """Exporta datos a Excel con múltiples hojas, manejando casos vacíos"""
    try:
        output = io.BytesIO()
...
st.markdown("**Versión 2.1** - Con exportación de datos, gráficos interactivos, caché optimizado y numeración desde 1")
<style>
    /* Responsive design */
    @media (max-width: 768px) {
        .main-header {
